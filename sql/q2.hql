...
WITH amenities_stats AS (
    SELECT
        ...
        ROUND(AVG(CASE WHEN r.`Air conditioning` THEN 1 ELSE 0 END) * 100, 1) AS air_cond_pct,
        ...
        ROUND(AVG(CASE WHEN r.`Hot water` THEN 1 ELSE 0 END) * 100, 1) AS hot_water_pct,
